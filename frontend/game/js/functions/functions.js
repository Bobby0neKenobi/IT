function randomBetween(min, max){
  ...
  function createScoreLable({score = 100, object}){
    const scoreLabel = document.createElement('label')
                  ...
                  gsap.to(scoreLabel, {opacity:0, y:-30, duration: 0.75, onComplete:() => {document.querySelector("#parentDiv").removeChild(scoreLabel)}})
  }
